...
import 'package:kmmi_food_app/ui/bookmarks/bookmark_list.dart';
import 'package:kmmi_food_app/ui/groceries/grocery_list.dart';
import 'package:kmmi_food_app/ui/recipes/recipe_list.dart';
import 'package:kmmi_food_app/ui/recipes/recipe_list_new.dart';
...
class _MainScreenState extends State<MainScreen> {
  ...
  void initState() {
    super.initState();
    pageList.add(const RecipeListNew());
    pageList.add(const BookmarkList());
